			...
			model.getDish(pendingDishId, function(dish) {
				...
				if (dish != undefined) {
					...
					for (var i = dish.extendedIngredients.length - 1; i >= 0; i--) {
						...
						<div class=\"col-md-3\" style=\"text-align: left\">" + dish.extendedIngredients[i].amount*numOfGuests + "\
						 ...
						 <div class=\"col-md-2\" style=\"text-align: center\">" + dish.extendedIngredients[i].amount*numOfGuests + "</div>\</div>"
					};
